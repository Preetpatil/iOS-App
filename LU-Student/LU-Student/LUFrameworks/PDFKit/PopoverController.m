...
-(CGPoint)originFromView:(UIView*)fromView
{
    ...
    if([_contentView arrowDirection]  ==  PopoverArrowDirectionUp ||
       [_contentView arrowDirection]  ==  PopoverNoArrow)
    {
...
-(CGRect)bestArrowDirectionAndFrameFromView:(UIView*)v
{
    ...
    // Fix for presentFromPoint from avolovoy's Popover fork
    float width  =  2.0f;
    float height  =  2.0f;
    ...
    else 
    {
        ...
        if((wl  ==  best_w || self.arrowDirection  ==  PopoverArrowDirectionRight) && self.arrowDirection !=  PopoverArrowDirectionLeft)
        {
    ...
    if(self.arrowDirection !=  PopoverNoArrow)
        _contentView.arrowDirection  =  bestDirection;
    
    //no arrow
    else _contentView.arrowDirection  =  PopoverNoArrow;
