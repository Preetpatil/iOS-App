...
//        titleY +=  (iconButtonHeight + buttonSpacing); titleHeight -=  (iconButtonHeight + buttonSpacing);
 ...
 /*
        ...
        lineButton.frame  =  CGRectMake(leftButtonY, BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
        ...
        eraserButton.frame  =  CGRectMake(leftButtonY, BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
        ...
        highlightButton.frame  =  CGRectMake(leftButtonY,BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
        ...
        penButton.frame  =  CGRectMake(leftButtonY,BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
...
//        titleY +=  (iconButtonHeight + buttonSpacing); titleHeight -=  (iconButtonHeight + buttonSpacing);
        ...
        colorButton.frame  =  CGRectMake(leftButtonY,BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
...
//        undoButton.frame  =  CGRectMake(leftButtonY, BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
...
//        redoButton.frame  =  CGRectMake(leftButtonY, BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
...
//        clearButton.frame  =  CGRectMake(leftButtonY, BUTTON_X, BUTTON_WIDTH, iconButtonHeight);
